...
def pth_params_2_ONNX():
    ...
    model_path = "phone_code_model/model_0.87_depoly.pth"
    ...
    export_onnx_file = "phone_code_model/model_0.87_depoly.onnx"  # 目的ONNX文件名
...
def load_onnx():
    ...
    so.optimized_model_filepath = "phone_code_model/model_0.87_depoly.onnx"

    ort_session = ort.InferenceSession('phone_code_model/model_0.87_depoly.onnx')
